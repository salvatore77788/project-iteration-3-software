...
public class AttendantGui {
	 ...
	 */
	/*
	 * public AttendantGui() { superStation = new SupervisionStation(); frame =
	 * superStation.screen.getFrame();
	 * 
	 * initComponents();
	 * 
	 * initGUI();
	 ...
	 * ar.setVisible(true);
	 * 
	 * // Initialize frame.setLocation(1000, 300); frame.setVisible(true);
	...
	private void setStation() {
		...
		// Data here needs to be taken from the actual software instead of the test
		// software
		// Since none of it is actually implemented on this branch, it'll have to be
		// done later

		// Set up buttons
		boolean isStationNull = currentSoftware == null;

		// jButtonBlockStation.setEnabled(!isStationNull && !currentSoftware.isBlocked
		// && !currentSoftware.isShutdown);
		// jButtonUnblockStation.setEnabled(!isStationNull && currentSoftware.isBlocked
		// && !currentSoftware.isShutdown);
		...
		jButtonRefillBanknoteDispenser
				.setEnabled(!isStationNull && !currentSoftware.isShutdown && !currentSoftware.isBlocked);
		jButtonRefillCoinDispenser
				.setEnabled(!isStationNull && !currentSoftware.isShutdown && !currentSoftware.isBlocked);
		// jButtonRefillInk.setEnabled(!isStationNull && !currentSoftware.isShutdown &&
		// !currentSoftware.isBlocked);
		...
		jButtonUnloadBanknoteStorage
				.setEnabled(!isStationNull && !currentSoftware.isShutdown && !currentSoftware.isBlocked);
		jButtonUnloadCoinStorage
				.setEnabled(!isStationNull && !currentSoftware.isShutdown && !currentSoftware.isBlocked);

		// Set up coin denomination list
		coinDispLM.clear();
		for (int i = 0; i < coinDenoms.length; i++)
			coinDispLM.addElement("$" + coinDenoms[i].toString() + ": "
					+ (isStationNull ? "--" : getCoinPercentage(coinDenoms[i]) + "%"));

		// Set up banknote denomination list
		bnDispLM.clear();
		for (int i = 0; i < bnDenoms.length; i++)
			bnDispLM.addElement(
					"$" + bnDenoms[i] + ": " + (isStationNull ? "--" : getBanknotePercentage(bnDenoms[i]) + "%"));

		// Storage labels
		jLabelCoinStorage.setText("Coin Storage: "
				+ (isStationNull ? "Unknown" : (currentSoftware.funds.getIsCoinStorageFull() ? "Full" : "Not Full")));
		jLabelBanknoteStorage.setText("Banknote Storage: " + (isStationNull ? "Unknown"
				: (currentSoftware.funds.getIsBanknoteStorageFull() ? "Full     " : "Not Full")));
	...
	private void initComponents() {
				...
				.addGroup(jPanel3Layout.createSequentialGroup().addGroup(jPanel3Layout
						...
						.addGroup(jPanel3Layout.createSequentialGroup().addContainerGap()
								.addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addGroup(jPanel3Layout.createSequentialGroup().addComponent(jLabelStationName)
										...
										.addGroup(jPanel3Layout.createSequentialGroup().addGroup(jPanel3Layout
												...
												.addGroup(jPanel3Layout
														.createSequentialGroup().addComponent(jLabelInk)
														.addPreferredGap(
																javax.swing.LayoutStyle.ComponentPlacement.RELATED,
																javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												...
												.addGap(218, 218, 218))))
						.addGroup(jPanel3Layout.createSequentialGroup()
								.addComponent(jSeparator2, javax.swing.GroupLayout.PREFERRED_SIZE, 377,
						...
						.addGroup(jPanel3Layout.createSequentialGroup().addGroup(jPanel3Layout
								...
								.addGroup(jPanel3Layout.createSequentialGroup().addGroup(jPanel3Layout
										...
										.addGroup(jPanel3Layout.createSequentialGroup().addContainerGap().addComponent(
												jScrollPane3, javax.swing.GroupLayout.PREFERRED_SIZE, 157,
												javax.swing.GroupLayout.PREFERRED_SIZE))
										.addGroup(jPanel3Layout.createSequentialGroup().addGap(40, 40, 40).addComponent(
												jButtonRefillCoinDispenser, javax.swing.GroupLayout.PREFERRED_SIZE, 89,
												javax.swing.GroupLayout.PREFERRED_SIZE)))
										.addGroup(jPanel3Layout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												...
												.addGroup(jPanel3Layout.createSequentialGroup()
														...
														.addGroup(jPanel3Layout
																...
																.addComponent(jLabelBD).addComponent(jScrollPane4,
								...
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										jPanel3Layout.createSequentialGroup().addGroup(jPanel3Layout
												...
												.addGroup(jPanel3Layout.createSequentialGroup()
														.addGap(0, 0, Short.MAX_VALUE).addComponent(jButtonRefresh))
								...
								.addGroup(
										jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 200,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
														jPanel3Layout.createSequentialGroup().addComponent(jLabelSC)
																.addGap(59, 59, 59)))))
						.addContainerGap()));
		jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel3Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabelStationName).addComponent(jButtonUnblockStation)
								.addComponent(jButtonBlockStation))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						...
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabelStatus).addComponent(jLabelStatusCode).addComponent(jLabelSC))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(jPanel3Layout.createSequentialGroup()
										.addGroup(jPanel3Layout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
												.addComponent(jLabelInk).addComponent(jButtonRefillInk))
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addGroup(jPanel3Layout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
												.addComponent(jLabelPaper).addComponent(jButtonRefillPaper))
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										...
										.addGroup(jPanel3Layout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
												.addComponent(jLabelCD).addComponent(jLabelBD))
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addGroup(jPanel3Layout
										...
										.addGroup(jPanel3Layout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
												.addComponent(jLabelCoinStorage).addComponent(jButtonUnloadCoinStorage))
										...
										.addGroup(jPanel3Layout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
												.addComponent(jButtonShutdown).addComponent(jButtonStartUp)
		...
		jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addComponent(jScrollPane1).addComponent(jPanel3, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
	...
	private void jButtonBlockStationActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (currentSoftware.scanAndBag.scanGUI != null)
	...
	private void jButtonRefillCoinDispenserActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (idx >= 0) {
			...
			AttendantActions.fillCoinDispenser(currentSoftware.scs, denom,
					Collections.nCopies(refillCount, new Coin(currency, denom)).toArray(new Coin[refillCount]));
		}
	...
	private void jButtonRefillBanknoteDispenserActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (idx >= 0) {
			...
			int refillCount = SelfCheckoutStation.BANKNOTE_DISPENSER_CAPACITY
					- currentSoftware.funds.getBanknoteCount(denom);
			AttendantActions.fillBanknoteDispenser(currentSoftware.scs, denom,
					Collections.nCopies(refillCount, new Banknote(currency, denom)).toArray(new Banknote[refillCount]));
		}
	...
	private void jMenuItemSCAddItemActionPerformed(java.awt.event.ActionEvent evt) {
		// TODO add your handling code here:
		// Possibly use a modal/pop up window for searching by PLU/name and linking to
		// the PLU catalog
	}
