...
public class ScanLargeItemGUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ScanLargeItemGUI frame = new ScanLargeItemGUI();
	...
	public ScanLargeItemGUI() {
		...
		scanLargeText.setText("Scanning a large item. ");
