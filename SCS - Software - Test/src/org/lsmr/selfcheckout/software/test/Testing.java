...
public class Testing {
	...
	public static void main(String[] args) throws DisabledException, SimulationException, OverloadException, EmptyException {
	...
	private void testStorageFull() throws DisabledException, SimulationException, OverloadException, EmptyException {
	...
	private void testRegularCash() throws DisabledException, SimulationException, OverloadException, EmptyException {
	...
	private void testCheckout() throws DisabledException, SimulationException, OverloadException, EmptyException {
		TestHardware testHardware = new TestHardware();
		SelfCheckoutStationSoftware software = new SelfCheckoutStationSoftware(testHardware.scs);
	...
	private void testReceiptPrinter() throws DisabledException, SimulationException, OverloadException, EmptyException {
		TestHardware testHardware = new TestHardware();
		SelfCheckoutStationSoftware software = new SelfCheckoutStationSoftware(testHardware.scs);
	...
	private void testBanknoteValidator() throws DisabledException, SimulationException, OverloadException {
		TestHardware testHardware = new TestHardware();
		SelfCheckoutStationSoftware software = new SelfCheckoutStationSoftware(testHardware.scs);
	...
	private void testBarcodeScannerSoftware() throws SimulationException, OverloadException {
		TestHardware testHardware = new TestHardware();
		SelfCheckoutStationSoftware software = new SelfCheckoutStationSoftware(testHardware.scs);
