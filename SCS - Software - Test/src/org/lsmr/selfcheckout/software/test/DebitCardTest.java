...
public class DebitCardTest {
	...
	public void Debit_is_Null() throws IOException {
		...
		assertFalse(pay.PayWithDebitCard(null, 1, new BigDecimal(5), "0000", new BigDecimal(6)));
	...
	public void Debit_isValid() throws IOException {
		...
		assertTrue(pay.PayWithDebitCard(debitCard_tap, 1, new BigDecimal(6), "0000", new BigDecimal(6)));

	}

	@Test
	public void invalid_payment_method() throws IOException {
		assertFalse(pay.PayWithDebitCard(debitCard_noTap, 0, new BigDecimal(6), "0000", new BigDecimal(6)));
	}

	@Test
	public void not_Debit() throws IOException {
		assertFalse(pay.PayWithDebitCard(creditCard, 1, new BigDecimal(6), "0000", new BigDecimal(6)));
	}

	@Test
	public void Bal_too_small() throws IOException {
		assertFalse(pay.PayWithDebitCard(debitCard_tap, 2, new BigDecimal(5), "0000", new BigDecimal(6)));
	}
	...
	public void insert_test_validPIN() throws IOException {
		assertTrue(pay.PayWithDebitCard(debitCard_noTap, 3, new BigDecimal(6), "1234", new BigDecimal(6)));
	}

	@Test(expected = InvalidPINException.class)
	public void insert_test_invalidPIN() throws IOException {
		assertFalse(pay.PayWithDebitCard(debitCard_noTap, 3, new BigDecimal(6), "1224", new BigDecimal(6)));
	}
